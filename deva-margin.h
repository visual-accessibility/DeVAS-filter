...
DEVA_float_image    *DEVA_float_add_margin ( int v_margin, int h_margin,
			DEVA_float_image *original );

DEVA_float_image    *DEVA_float_strip_margin ( int v_margin, int h_margin,
